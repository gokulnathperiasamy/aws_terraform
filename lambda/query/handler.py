...
def _build_prompt(question, context_text):
    return (
        ...
        "Format the answer in Markdown. For all math expressions use LaTeX: inline math with $...$ and display/block math with $$...$$. Do not use \\( \\) or \\[ \\] delimiters.\n"
        "Never copy raw text from the context directly. Always rewrite math expressions in proper LaTeX.\n"
